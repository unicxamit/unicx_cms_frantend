...
const MissionVision = () => {
     ...
     const companyCarouselRef = useRef(null);
      ...
      useEffect(() => {
        const carouselNode = companyCarouselRef.current;
        if (!carouselNode || !window.jQuery || companys.length === 0) return;

        const $carousel = window.jQuery(carouselNode);
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-8 col-lg-12"> 
                                <div
                                  ...
                                  className="owl-carousel mission-company-carousel owl-btn-vertical-center"
                                >
                                {companys?.map((logo, index) => (
                                    ...
                                    <div className="item" key={`first-${index}`}>
                                                        ...
                                                        <div className="ow-client-logo">
                                                          {logo.images.map((img, imageIndex) => (
                                                          
                                                                         <div className="client-logo client-logo-media" style={{ width: "150px", margin: "0 auto" }} key={`${logo._id || index}-${imageIndex}`}>
                                                <JobZImage src={img} alt={`Company ${imageIndex + 1}`} /></div>
                                                          ))}
                                                        </div>
                                                      ) : (
                                                        <span>No Image</span>
