         ...
         useEffect(() => {
             ...
             const fetchAllBlogs = async () => {
                 try {
                     ...
                     const activeCaseStudies=(data.caseStudies || []).filter((c)=>c.status==="active")
                     setAllBlogs(activeCaseStudies);
                 } catch (err) {
                 ...
                 <>
                     <style>{`
                         ...
                         .jobs-skeleton::after {
                             ...
                             animation: jobsShimmer 1.4s infinite;
                         }

                         .jobs-skeleton-image { height: 180px; width: 100%; }
                         .jobs-skeleton-meta { height: 14px; width: 70%; }
                         .jobs-skeleton-title { height: 22px; width: 90%; }
                         .jobs-skeleton-text { height: 12px; width: 100%; }
                         .jobs-skeleton-text.short { width: 78%; }
                         .jobs-skeleton-link { height: 14px; width: 35%; }
                         ...
                         <div className="container">
                             <div className="jobs-skeleton-grid">
                                 {Array.from({ length: 6 }).map((_, index) => (
                                     <div className="jobs-skeleton-card" key={index}>
                                         <div className="jobs-skeleton jobs-skeleton-image" />
                                         <div className="jobs-skeleton jobs-skeleton-meta" />
                                         <div className="jobs-skeleton jobs-skeleton-title" />
                                         <div className="jobs-skeleton jobs-skeleton-text" />
                                         <div className="jobs-skeleton jobs-skeleton-text short" />
                                         <div className="jobs-skeleton jobs-skeleton-link" />
                                     </div>
                                 ))}
                             </div>
                         </div>
